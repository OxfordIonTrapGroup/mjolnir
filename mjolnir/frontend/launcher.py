...
class ConnectionDialog(QtWidgets.QDialog):
    ...
    def init_ui(self):
        self.conn_type = QtWidgets.QComboBox()
        self.conn_type.insertItems(0, ["Remote", "Local"])
        self.conn = QtWidgets.QPushButton("Connect")
        ...
        self.artiq_port = QtWidgets.QLineEdit()
        self.zmq_port = QtWidgets.QLineEdit()
        ...
        self.get_cam_list = QtWidgets.QPushButton("Get Camera List")
        self.get_cam_list.clicked.connect(self._get_cam_list)
        self.serial_number = QtWidgets.QComboBox()
        self.serial_number.setEditable(True)

        self.conn_params = QtWidgets.QStackedWidget()
        ...
        self.conn_type_layout.addRow(
            QtWidgets.QLabel("Connection Type:"), self.conn_type)
        self.conn_type_widget = QtWidgets.QWidget()
        ...
        self.remote_params_widget = QtWidgets.QWidget()
        ...
        self.local_params_widget = QtWidgets.QWidget()
